# Experiment 1 — How much can a sample fool you?
...
Without asking Gemini to write new code, go back to the **code cell generated by Prompt 3 in this experiment**. Change the sample size from `100` to `25` and run that cell again.
